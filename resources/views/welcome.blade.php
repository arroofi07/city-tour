...
<body class="bg-gradient-to-br from-slate-900 via-cyan-900 to-teal-900 font-outfit text-white min-h-screen">
    ...
    <section id="video-showcase" class="py-16 sm:py-24 relative overflow-hidden">
        <!-- Background Elements -->
        <div class="absolute inset-0">
            <div class="absolute top-20 right-10 w-40 h-40 bg-gradient-to-r from-red-500/20 to-pink-500/20 rounded-full blur-2xl animate-pulse"></div>
            <div class="absolute bottom-20 left-10 w-60 h-60 bg-gradient-to-r from-cyan-500/20 to-teal-500/20 rounded-full blur-3xl animate-bounce slow"></div>
        ...
        <div class="max-w-8xl mx-auto px-4 sm:px-6 relative z-10">
            ...
            <div class="text-center max-w-4xl mx-auto mb-12 sm:mb-16">
                <div class="inline-flex items-center glass-card rounded-full px-6 sm:px-8 py-3 sm:py-4 mb-8 group hover:scale-105 transition-all duration-300">
                    <div class="w-3 h-3 bg-gradient-to-r from-red-400 to-pink-400 rounded-full mr-3 animate-pulse"></div>
                    <span class="text-white/90 font-bold text-sm sm:text-lg tracking-wider">🎥 VIDEO SHOWCASE</span>
                    <div class="w-3 h-3 bg-gradient-to-r from-cyan-400 to-teal-400 rounded-full ml-3 animate-pulse"></div>
                </div>

                <h2 class="text-4xl sm:text-6xl md:text-7xl font-space-grotesk font-black mb-6 sm:mb-8 leading-tight">
                    <span class="block text-white mb-2">Jelajahi Lewat</span>
                    <span class="bg-gradient-to-r from-red-300 via-pink-300 to-cyan-300 bg-clip-text text-transparent animate-pulse">
                        Video Stories 📹
                    </span>
                </h2>

                <p class="text-xl sm:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed">
                    Saksikan keindahan Air Manis dalam video yang memukau! 🌊✨
                </p>
            </div>
            ...
            <div class="relative max-w-6xl mx-auto">
                <!-- Main Video Display -->
                <div class="glass-card rounded-[2rem] p-4 sm:p-6 relative overflow-hidden group hover:scale-[1.01] transition-all duration-500">
                    <div class="absolute inset-0 bg-gradient-to-r from-red-500/10 via-pink-500/10 to-cyan-500/10 opacity-50 group-hover:opacity-70 transition-opacity duration-300"></div>

                    <div class="relative z-10">
                        <!-- Video Frame -->
                        <div class="aspect-video rounded-2xl overflow-hidden bg-gradient-to-br from-slate-800 to-slate-900 relative">
                            <div id="video-container" class="w-full h-full">
                                <!-- Loading State -->
                                <div id="video-loading" class="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-slate-800 to-slate-900">
                                    <div class="text-center">
                                        <div class="w-16 h-16 border-4 border-red-400/30 border-t-red-400 rounded-full animate-spin mx-auto mb-4"></div>
                                        <p class="text-white/60">Memuat video...</p>
                                    </div>
                                </div>
                                ...
                                <!-- Error State -->
                                <div id="video-error" class="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-slate-800 to-slate-900" style="display: none;">
                                    <div class="text-center">
                                        ...
                                        <p class="text-white/60 text-sm">Video tidak dapat dimuat</p>
                                        <div class="mt-3 flex flex-col sm:flex-row gap-2 items-center justify-center">
                                            <button id="retry-video" class="glass-card px-4 py-2 rounded-full text-white text-sm hover:scale-110 transition-transform">
                                                Coba Lagi
                                            </button>
                                            <a id="watch-on-youtube" href="#" target="_blank" class="glass-card px-4 py-2 rounded-full text-white text-sm hover:scale-110 transition-transform inline-flex items-center space-x-2">
                            ...
                            <div class="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-3">
                                    <button id="autoplay-toggle" class="glass-card px-4 py-2 rounded-full text-white font-semibold hover:scale-110 transition-transform flex items-center space-x-2">
                                ...
                                <div class="flex items-center space-x-2">
                                    <button id="prev-video" class="glass-card p-3 rounded-full text-white hover:scale-110 transition-transform">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                                        </svg>
                                    </button>
                                    <button id="next-video" class="glass-card p-3 rounded-full text-white hover:scale-110 transition-transform">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mt-4 text-center">
                            <h3 id="video-title" class="text-xl sm:text-2xl font-bold text-white mb-2">Air Manis Beach Experience</h3>
                            <p id="video-description" class="text-white/80 text-sm sm:text-base">Jelajahi keindahan Pantai Air Manis melalui video yang menakjubkan</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8">
                    <div class="flex items-center justify-center space-x-4 overflow-x-auto pb-4">
                        <div id="video-thumbnails" class="flex space-x-3 sm:space-x-4">
                ...
                <div class="flex justify-center mt-6">
                    <div class="flex space-x-2" id="video-dots">
    ...
    <footer class="py-12 sm:py-16 relative overflow-hidden">
        <div class="max-w-8xl mx-auto px-4 sm:px-6">
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li class="text-white/60">📱 +62 822-8326-1642</li>
                        <li class="text-white/60">💬 +62 822-8326-1642 (WhatsApp)</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="flex space-x-4">
                        <a href="https://www.instagram.com/air_manis_beach/" class="text-white/60 hover:text-cyan-300 transition-colors">
                        ...
                        <a href="https://youtube.com/@airmanisbeach?si=fSXQuqWKv-3lKh8I" class="text-white/60 hover:text-cyan-300 transition-colors">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M21.593 7.203a2.506 2.506 0 00-1.762-1.766C18.265 5.007 12 5 12 5s-6.264-.007-7.831.404a2.56 2.56 0 00-1.766 1.778C2 8.769 2 12 2 12s0 3.231.437 4.797a2.506 2.506 0 001.767 1.763C5.736 18.993 12 19 12 19s6.264.007 7.831-.404a2.506 2.506 0 001.767-1.763C22 15.231 22 12 22 12s0-3.231-.437-4.797z"></path>
                                <path fill="currentColor" d="M9.75 15.5V8.5l6.5 3.5-6.5 3.5z"></path>
                            </svg>
            ...
            <!-- Map Widget Section -->
            <div class="mt-12 glass-card rounded-3xl p-6 relative overflow-hidden group hover:scale-[1.01] transition-all duration-500">
                <div class="absolute inset-0 bg-gradient-to-r from-cyan-500/10 via-teal-500/10 to-emerald-500/10 opacity-50"></div>

                <div class="relative z-10">
                    <!-- Section Title -->
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            <h3 class="text-lg font-bold text-white mb-1">📍 Lokasi Kami</h3>
                            <p class="text-white/60 text-sm">Pantai Air Manis, Padang Selatan</p>
                        </div>
                        <a href="https://maps.google.com/?q=-0.9932124103200699, 100.3635211297141" target="_blank"
                            class="glass-card px-4 py-2 rounded-full text-sm font-semibold text-cyan-300 hover:scale-110 transition-transform inline-flex items-center space-x-2">
                    ...
                    <div class="relative rounded-2xl overflow-hidden border border-white/20">
                        <div id="footer-map" class="w-full h-64 sm:h-72 lg:h-80 bg-slate-800/50"></div>

                        <!-- Loading Placeholder -->
                        <div id="map-loading" class="absolute inset-0 flex items-center justify-center bg-slate-800/50">
                            <div class="text-center">
                                <div class="w-12 h-12 border-4 border-cyan-300/30 border-t-cyan-300 rounded-full animate-spin mx-auto mb-2"></div>
                                <p class="text-white/60 text-sm">Memuat peta...</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid sm:grid-cols-2 gap-4 mt-4">
                        <div class="glass-card rounded-xl p-3">
                            <p class="text-cyan-300 text-xs font-semibold mb-1">KOORDINAT</p>
                            <p class="text-white text-sm">-0.9911° S, 100.3598° E</p>
                        </div>
                        <div class="glass-card rounded-xl p-3">
                            <p class="text-cyan-300 text-xs font-semibold mb-1">JAM BUKA</p>
                            <p class="text-white text-sm">Setiap Hari, 06:00 - 18:00 WIB</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function sendToWhatsApp() {
            ...
            const adminWhatsApp = '6282283261642'; // Ganti dengan nomor admin Air Manis Tour
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Koordinat Pantai Air Manis, Padang
            const airManisCoords = [-0.9911, 100.3598];

            // Initialize the map
            const map = L.map('footer-map', {
                center: airManisCoords,
                zoom: 15,
            ...
            const beachIcon = L.divIcon({
                html: `
                    <div class="relative">
                        <div class="absolute inset-0 bg-gradient-to-r from-cyan-500 to-teal-500 rounded-full animate-ping"></div>
                        <div class="relative bg-gradient-to-r from-cyan-500 to-teal-500 rounded-full w-12 h-12 flex items-center justify-center shadow-lg">
            ...
            // Add marker for Pantai Air Manis
            const marker = L.marker(airManisCoords, {
                    icon: beachIcon
                })
                .addTo(map)
                .bindPopup(`
                    <div class="text-center p-2">
                        <h4 class="font-bold text-lg mb-1">Pantai Air Manis 🌊</h4>
                        <p class="text-sm text-gray-600 mb-2">Destinasi Legendaris Padang</p>
                        <a href="https://maps.google.com/?q=-0.9911,100.3598" target="_blank"
                           class="inline-flex items-center space-x-1 text-blue-600 hover:text-blue-800 text-sm font-medium">
                            <span>Navigasi</span>
            ...
            // Hide loading after a short delay (fallback)
            setTimeout(function() {
            ...
            // Enable scroll zoom when user clicks on map (better mobile UX)
    ...
    <!-- YouTube Video Slider Script -->
    <script>
        // YouTube Video Configuration
        const youtubeVideos = [
            {
                id: 'tOXdmx_mgrY', // Air Manis Beach - Video 1
                title: 'Keindahan Pantai Air Manis',
                description: 'Saksikan pesona pantai legendaris dengan pemandangan yang memukau dan ombak yang menenangkan'
            },
            {
                id: 'g-D9itwvgZA', // Air Manis Beach - Video 2
                title: 'The Beauty of Air Manis Beach',
                description: 'Jelajahi keindahan pantai Air Manis dengan segala pesonanya yang tak terlupakan'
            },
            {
                id: 'tOXdmx_mgrY', // Repeat video 1 for more content
                title: 'Sunset Spektakuler di Air Manis',
                description: 'Momen sunset terbaik yang wajib disaksikan di Pantai Air Manis dengan view yang menakjubkan'
            },
            {
                id: 'g-D9itwvgZA', // Repeat video 2 for more content
                title: 'Legenda Batu Malin Kundang',
                description: 'Menyelami kisah legendaris yang menjadi daya tarik utama Air Manis dan sejarah yang mengharukan'
            }
        ];
        ...
        const autoplayDuration = 8000; // 8 seconds per video

        // DOM Elements
        const youtubePlayer = document.getElementById('youtube-player');
        const videoLoading = document.getElementById('video-loading');
        const videoError = document.getElementById('video-error');
        const retryButton = document.getElementById('retry-video');
        const watchOnYoutubeBtn = document.getElementById('watch-on-youtube');
        ...
        const thumbnailContainer = document.getElementById('video-thumbnails');
        const dotsContainer = document.getElementById('video-dots');

        // Initialize Video Slider
        function initVideoSlider() {
            console.log('Initializing video slider with', youtubeVideos.length, 'videos');
            youtubeVideos.forEach((video, index) => {
                console.log(`Video ${index + 1}: ${video.id} - ${video.title}`);
            });
        ...
        function generateThumbnails() {
            ...
            youtubeVideos.forEach((video, index) => {
                ...
                thumbnail.className = `relative cursor-pointer group transition-all duration-300 ${index === currentVideoIndex ? 'scale-110 ring-2 ring-cyan-400' : 'hover:scale-105'}`;
                thumbnail.innerHTML = `
                    <div class="glass-card rounded-xl overflow-hidden w-24 h-16 sm:w-32 sm:h-20">
                        <img src="https://img.youtube.com/vi/${video.id}/hqdefault.jpg"
                             alt="${video.title}"
                             onerror="this.src='https://img.youtube.com/vi/${video.id}/default.jpg'; console.log('Thumbnail fallback for video: ${video.id}');"
        ...
        function generateDots() {
            ...
            youtubeVideos.forEach((_, index) => {
                ...
                dot.className = `w-3 h-3 rounded-full transition-all duration-300 ${index === currentVideoIndex ? 'bg-cyan-400 scale-125' : 'bg-white/30 hover:bg-white/50'}`;
        ...
        function loadVideo(index) {
            ...
            console.log('Loading video:', video.id, video.title);
            ...
            // Update YouTube link for error fallback
            if (watchOnYoutubeBtn) {
                watchOnYoutubeBtn.href = `https://www.youtube.com/watch?v=${video.id}`;
            }

            // Load video with minimal parameters for maximum compatibility
            // Based on YouTube oEmbed response format
            const embedUrl = `https://www.youtube.com/embed/${video.id}?feature=oembed&controls=1&rel=0&modestbranding=1`;
            ...
            youtubePlayer.onerror = function() {
                ...
                // Try alternative embed URL without oembed feature
                const fallbackUrl = `https://www.youtube.com/embed/${video.id}?controls=1&rel=0`;
                youtubePlayer.src = fallbackUrl;

                // If still fails after fallback attempt, show error
                setTimeout(() => {
            ...
            // Fallback timeout to ensure UI updates (more generous for slower connections)
            setTimeout(() => {
                if (videoLoading.style.display !== 'none') {
                    console.log('Video load timeout, showing player anyway for:', video.id);
                    videoLoading.style.display = 'none';
                    youtubePlayer.style.display = 'block';
                    if (videoError) videoError.style.display = 'none';
                    updateThumbnails();
        ...
        function updateThumbnails() {
            ...
            Array.from(thumbnails).forEach((thumb, index) => {
                if (index === currentVideoIndex) {
                    thumb.className = thumb.className.replace('hover:scale-105', 'scale-110 ring-2 ring-cyan-400');
                } else {
                    thumb.className = thumb.className.replace('scale-110 ring-2 ring-cyan-400', 'hover:scale-105');
                }
            });
        }
        ...
        function updateDots() {
            ...
            Array.from(dots).forEach((dot, index) => {
                if (index === currentVideoIndex) {
                    dot.className = 'w-3 h-3 rounded-full transition-all duration-300 bg-cyan-400 scale-125';
                } else {
                    dot.className = 'w-3 h-3 rounded-full transition-all duration-300 bg-white/30 hover:bg-white/50';
                }
            });
        }
        ...
        // Previous Video
        function prevVideo() {
            const prevIndex = currentVideoIndex === 0 ? youtubeVideos.length - 1 : currentVideoIndex - 1;
            loadVideo(prevIndex);
        }
        ...
        function toggleAutoplay() {
            ...
            if (autoplayEnabled) {
                ...
                autoplayIcon.textContent = '▶️';
                autoplayText.textContent = 'Manual';
                stopAutoplay();
            }
        }

        // Initialize video slider when DOM is ready (run after existing map script)
        setTimeout(function() {
            initVideoSlider();
            ...
            if (retryButton) {
                retryButton.addEventListener('click', () => {
                    console.log('Retrying video load for:', youtubeVideos[currentVideoIndex].id);
                    loadVideo(currentVideoIndex);
                });
            }

            // Pause autoplay when user interacts with video area
        ...
        }, 1500); // Delay to ensure all elements are loaded
    </script>
